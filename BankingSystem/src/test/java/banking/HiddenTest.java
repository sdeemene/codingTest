...
public class HiddenTest {
    ...
    public void setUp() {
        ...
        person4 = new Person("Saint", "Deemene", 4);
        ...
        consumerAccountNr4 = bank.openConsumerAccount(person4, 4444, 300.00);

        Company company1 = new Company("BigCorp1", 1, 5);
        Company company2 = new Company("BigCorp2", 2, 6);
